    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10 max-w-3xl space-y-8">
        <section className="text-center space-y-2">
          <h1 className="font-display text-5xl md:text-6xl">O que vais cozinhar hoje?</h1>
        ...
        <Tabs defaultValue="pantry" className="w-full">
          <TabsList className="grid grid-cols-3 w-full h-auto">
            <TabsTrigger value="pantry" className="py-2">Tenho em casa</TabsTrigger>
            <TabsTrigger value="dish" className="py-2">Quero um prato</TabsTrigger>
            <TabsTrigger value="surprise" className="py-2">Surpreende-me</TabsTrigger>
          </TabsList>
